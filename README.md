...
## 📜 许可协议
 本项目采用 **Apache License 2.0** 许可，并附加商业授权条款。具体如下：
 - **非商业用途**：可自由使用、修改、分发，但必须保留原始版权声明和许可文件。
 - **商业盈利**：若通过本项目（包括修改版本）直接或间接获得商业收益，**必须提前 [联系作者](mailto:xxxzhou.xian@foxmail.com) 获取书面授权**。
