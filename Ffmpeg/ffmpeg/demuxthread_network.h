#ifndef DEMUXTHREAD_NETWORK_H
#define DEMUXTHREAD_NETWORK_H
...
class DemuxThread_network : public Thread
{
public:
	DemuxThread_network(AVPacketQueue *audio_queue, AVPacketQueue *video_queue);
	~DemuxThread_network();
